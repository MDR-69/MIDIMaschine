...
//Guitar Wing parameters
boolean beatmasher1_active = false;
boolean beatmasher2_active = false;
boolean beatmasher3_active = false;
boolean beatmasher4_active = false;
...
void noteOn(int channel, int pitch, int velocity, long timestamp, String bus_name) {
  ...
  //else if (bus_name == MIDI_BUS_CONFIGURATION_GUITAR_WING) {
    ...
    switch (pitch) {
      ...
      case PITCH_WING_BIG_ROUND_BUTTON_2: sendMidiOut_On_GuitarWing_Stutter3();break;
      case PITCH_WING_BIG_ROUND_BUTTON_3: sendMidiOut_On_GuitarWing_Stutter2();break;
      case PITCH_WING_BIG_ROUND_BUTTON_4: sendMidiOut_On_GuitarWing_Stutter5();break;
      case PITCH_WING_SMALL_RECTANGLE_1:  sendMidiOut_On_GuitarWing_Beatmasher1();break;
      case PITCH_WING_SMALL_RECTANGLE_2:  sendMidiOut_On_GuitarWing_Beatmasher2();break;
      case PITCH_WING_SMALL_RECTANGLE_3:  sendMidiOut_On_GuitarWing_Beatmasher3();break;
      case PITCH_WING_SMALL_RECTANGLE_4:  sendMidiOut_On_GuitarWing_Beatmasher4();break;
      case PITCH_TOGGLE:                  sendMidiOut_On_GuitarWing_Stutter4();break;
      default: break;
    }
  }
}
...
void noteOff(int channel, int pitch, int velocity, long timestamp, String bus_name) {
  ...
  //else if (bus_name == MIDI_BUS_CONFIGURATION_GUITAR_WING) {
    ...
    switch (pitch) {
      ...
      case PITCH_WING_BIG_ROUND_BUTTON_2: sendMidiOut_Off_GuitarWing_Stutter3();break;
      case PITCH_WING_BIG_ROUND_BUTTON_3: sendMidiOut_Off_GuitarWing_Stutter2();break;
      case PITCH_WING_BIG_ROUND_BUTTON_4: sendMidiOut_Off_GuitarWing_Stutter5();break;
      case PITCH_TOGGLE:                  sendMidiOut_Off_GuitarWing_Stutter4();break;
      default: break;
    }
  }
}
...
void sendMidiOut_On_Stutter6() {
  myBus.sendControllerChange(CHANNEL_GROUP_A1, 32, 127);
}

void sendMidiOut_On_Stutter7() {
...
void sendMidiOut_On_GuitarWing_Stutter1() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 15, 127);
}

void sendMidiOut_On_GuitarWing_Stutter2() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 20, 127);
}

void sendMidiOut_On_GuitarWing_Stutter3() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 30, 127);
}

void sendMidiOut_On_GuitarWing_Stutter4() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 32, 127);
}

void sendMidiOut_On_GuitarWing_Stutter5() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 78, 127);
}

void sendMidiOut_On_GuitarWing_Mute() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 5, 127);
}

void sendMidiOut_On_GuitarWing_OneOctaveUp() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 71, 63);
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 76, 127);
}

void sendMidiOut_On_GuitarWing_TwoOctaveUp() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 71, 127);
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 76, 127);
}

void sendMidiOut_On_GuitarWing_Beatmasher1() {
  if (beatmasher1_active) {
    //Reset the beatmasher
    beatmasher1_active = !beatmasher1_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 79, 0);
  }
  else {
    //Set the beatmasher
    beatmasher1_active = !beatmasher1_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 79, 127);
  }
}

void sendMidiOut_On_GuitarWing_Beatmasher2() {
  if (beatmasher2_active) {
    //Reset the beatmasher
    beatmasher2_active = !beatmasher2_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 80, 0);
  }
  else {
    //Set the beatmasher
    beatmasher2_active = !beatmasher2_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 80, 127);
  }
}

void sendMidiOut_On_GuitarWing_Beatmasher3() {
  if (beatmasher3_active) {
    //Reset the beatmasher
    beatmasher3_active = !beatmasher3_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 81, 0);
  }
  else {
    //Set the beatmasher
    beatmasher3_active = !beatmasher3_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 81, 127);
  }
}

void sendMidiOut_On_GuitarWing_Beatmasher4() {
  if (beatmasher4_active) {
    //Reset the beatmasher
    beatmasher4_active = !beatmasher4_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 82, 0);
  }
  else {
    //Set the beatmasher
    beatmasher4_active = !beatmasher4_active;
    myBus.sendControllerChange(CHANNEL_GROUP_D1, 82, 127);
  }
}
...
void sendMidiOut_Off_Stutter6() {
  myBus.sendControllerChange(CHANNEL_GROUP_A1, 32, 0);
}

void sendMidiOut_Off_Stutter7() {
...
void sendMidiOut_Off_GuitarWing_Stutter1() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 15, 0);
}

void sendMidiOut_Off_GuitarWing_Stutter2() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 20, 0);
}

void sendMidiOut_Off_GuitarWing_Stutter3() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 30, 0);
}

void sendMidiOut_Off_GuitarWing_Stutter4() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 32, 0);
}

void sendMidiOut_Off_GuitarWing_Stutter5() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 78, 0);
}

void sendMidiOut_Off_GuitarWing_Mute() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 5, 0);
}

void sendMidiOut_Off_GuitarWing_OneOctaveUp() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 71, 0);
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 76, 0);
}

void sendMidiOut_Off_GuitarWing_TwoOctaveUp() {
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 71, 0);
  myBus.sendControllerChange(CHANNEL_GROUP_D1, 76, 0);
}
...
void sendMidiOut_CC_Turnado1(int value) {
...
void sendMidiOut_CC_Turnado2(int value) {
...
void sendMidiOut_CC_Turnado3(int value) {
...
void sendMidiOut_CC_Turnado4(int value) {
...
void sendMidiOut_CC_Turnado5(int value) {
...
void sendMidiOut_CC_Deathwish(int value) {
...
void sendMidiOut_CC_Sidechain(int value) {
...
void sendMidiOut_CC_PitchupGR_On(int value) {
...
void sendMidiOut_CC_PitchupGR_Off(int value) {
